	...
	<div class="mgadin-hero">
		<div class="mge-info-content">
			<div class="mge-info-hello">
				...
				$demo_link = esc_url('https://news.wpteamx.com/newsx-paper-pro-demos/');
			...
			<div class="mge-info-desc">
				...
				<div><?php printf(esc_html__('%1$s PRO version is now available with an auto-setup feature!! Only active the theme and follow auto-setup then your site will be ready with lots of advanced features. Now create your site like a pro with only a few clicks!!!! So why late get pro now ', 'newsx-paper'), $current_theme_name); ?></div>
			</div>
			<div class="mge-info-actions">
				...
				<a href="<?php echo esc_url($demo_link); ?>" target="_blank" class="button button-primary demo-btn">
					<?php esc_html_e('View Demo', 'newsx-paper'); ?>
				</a>
...
{
	$hide_date = get_option('newsxpaper_info_hidedate1');
	if (!empty($hide_date)) {
...
function newsx_paper_new_optins_texts_init()
{
	if (isset($_GET['xbnotice']) && $_GET['xbnotice'] == 1) {
		update_option('newsxpaper_info_hidedate1', current_time('mysql'));
	}
}
